...
'use strict';
angular.module('FouleFactoryApiLib').factory('TaskAnswerChoicesController',function($q,Configuration,HttpClient,APIHelper){
    return{
        /**
         ...
         */
        getTaskAnswerChoicesGet : function(id, acceptLanguage){
